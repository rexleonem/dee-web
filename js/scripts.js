...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'https://www.innovationplans.com/idesign/avo2/img/logo-dark.png');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'https://www.innovationplans.com/idesign/avo2/img/logo-light.png');
        }
    });
    ...
    $('.topnav .menu-icon').on('click', function () {
        ...
        if (open) {
            ...
            logoChan.attr('src', 'https://www.innovationplans.com/idesign/avo2/img/logo-light.png');
            ...
            logoChan.attr('src', 'https://www.innovationplans.com/idesign/avo2/img/logo-dark.png');
...
$(window).on("load", function () {
    ...
    $('#contact-form').on('submit', function (e) {
        if (!e.isDefaultPrevented()) {
            var url = "https://www.innovationplans.com/idesign/avo2/contact.php";
